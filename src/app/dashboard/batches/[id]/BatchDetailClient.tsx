...
export function BatchDetailClient({ batch, reports, sentCount, missingEmailCount, stats, unopenedCount }: Props) {
  ...
  return (
    <>
      ...
      <div className="px-page" style={{ padding: "0 32px 32px", maxWidth: 860 }}>
        {unopenedCount > 0 && (
        ...
        {/* Stats row */}
        <div className="grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 20, marginTop: unopenedCount > 0 ? 0 : 20 }}>
