...
import { LayoutDashboard, UploadCloud, Users, FileText, Settings, ChevronsUpDown } from "lucide-react";
...
export function Sidebar({ firmName, plan }: SidebarProps) {
  ...
  return (
    <aside
      style={{ background: "#0A0F1E", width: 220, minWidth: 220, display: "flex", flexDirection: "column", minHeight: "100vh", borderRight: "1px solid rgba(255,255,255,0.06)", flexShrink: 0 }}
    >
      {/* Logo */}
      <div style={{ display: "flex", alignItems: "center", padding: "20px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
